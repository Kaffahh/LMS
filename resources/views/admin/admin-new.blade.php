...
<main class="flex flex-col min-h-screen">
                ...
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-9 h-9 rounded-full" src="{{ asset('storage/images/pp2.jpeg') }}" alt="user photo">
                        </button>
                    </div>
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 h-screen w-64 md:w-20 pt-16 transform md:translate-x-0 -translate-x-full transition-all duration-300 ease-in-out bg-cover bg-no-repeat md:fixed md:top-0 md:left-0 md:z-40 md:h-screen md:bg-no-repeat"
        style="background-image: url('{{ asset('storage/images/bg-lms1.jpg') }}');">
        <div class="h-full overflow-y-auto transition-all duration-300 ease-in-out">
            <ul class="space-y-4 p-2">
                <li>
                    <a href="#" class="flex items-center p-4 rounded-lg text-white hover:bg-gray-200 transition-all duration-300 ease-in-out">
                        <i class="bi bi-house-door text-2xl"></i>
                        <span class="ml-3 md:hidden text-white transition-opacity duration-300 ease-in-out">Beranda</span>
                    </a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 transition-all duration-300 ease-in-out">
                        <i class="bi bi-calendar text-2xl"></i>
                        <span class="ml-3 md:hidden text-white transition-opacity duration-300 ease-in-out">Tugas</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <!-- Overlay for Mobile -->
    <div id="overlay" class="fixed inset-0 bg-black opacity-50 hidden z-30 md:hidden transition-opacity duration-300 ease-in-out"></div>

    <!-- Content -->
    <div id="content-area" class="flex-1 p-8 transition-all duration-300 ease-in-out pt-20 md:ml-20">
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div class="h-40 rounded-lg bg-gray-200 shadow-inner dark:bg-gray-700 flex items-center justify-center p-4">
